...
def Delaunay_triangulation(input_points):
    ...
    input_points = [[276, 454], [301, 440], [334, 450], [304, 461], [402, 452], [435, 432], [464, 449], [439, 461], [330, 531], [365, 488], [410, 519], [370, 544], [321, 582], [364, 565], [416, 576], [365, 593], [371, 285], [371, 681], [508, 496], [245, 514], [252, 362], [500, 344], [283, 627], [481, 620], [572, 660], [721, 721], [206, 718], [122, 856], [413, 766], [404, 898], [105, 983], [750, 964], [2, 6], [2, 1016], [764, 1016], [764, 6]]


    for idx in range(len(input_points)):
        input_points[idx][0] = int(input_points[idx][0]/1.7)+20
        input_points[idx][1] = int(input_points[idx][1]/1.7)+20
