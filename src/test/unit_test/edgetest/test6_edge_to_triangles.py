...
def Delaunay_triangulation(input_points):
    ...
    input_points = [[259, 342], [345, 260], [349, 423], [387, 332], [413, 58], [436, 99], [499, 282], [591, 147], [616, 232]]
    ...
    edges_to_triangels(edges)



def edges_to_triangels(edges):
    triangles = []
            ...
            if pp1 != None:
                ...
                for e2 in edges:
                    ...
                    if pp2 != None and same_point_test(pp2, p2):
                        ...
                        triangles.append([now_edge, e1, e2])
    ...
    for t in triangles:
        ...
        for pp in t[1]:
            if not same_point_test(pp, p1) and not same_point_test(pp, p2):
                p3 = pp
                break 
        ...
        color_point(center, 'green')

        color_edge(t[0], 'green')
        color_edge(t[1], 'green')
        color_edge(t[2], 'green')
        raw_input()
        color_edge(t[0], 'red')
        color_edge(t[1], 'red')
        color_edge(t[2], 'red')
