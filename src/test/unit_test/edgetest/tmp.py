...
def get_sorted_candidates(a, b, point_set):
    to_return = []
    v1 = subtract(b, a)
    for p in point_set:
...
def Delaunay_recursive_actor(point_set):
    ...
    while lr_edge != None:
        ...
        sorted_right_point_set_with_angles = get_sorted_candidates(lr_right_point, lr_left_point, right_point_set)
        sorted_right_point_set_with_angles = sorted_right_point_set_with_angles[::-1]
        sorted_left_point_set_with_angles = get_sorted_candidates(lr_left_point, lr_right_point, left_point_set)
