...
def UI_run():
    ...
    def run_triangulation():
        ...
        #show_progress(canvas, src_edges, 'green')

        src_triangles = edges_to_triangels(src_edges)
        src_triangles_with_id = assign_triangles_id(src_triangles, src_points)
        
        triangle_pairs = get_triangle_pairs(src_triangles_with_id, dst_points)
